...
4. configure envoy with manifest in [services/gateway/envoy/config.yaml](services/gateway/envoy/config.yaml)
...
3. use [secrets/seal.sh](services/secrets/seal.sh) to generate encrypted secrets, can be commited safely within your repo
